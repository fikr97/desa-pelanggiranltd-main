-- MIGRASI LENGKAP: Solusi Akses Data Penduduk untuk Form Tugas

-- Hapus fungsi sebelumnya
DROP FUNCTION IF EXISTS get_penduduk_for_form(UUID);

-- Buat fungsi yang lebih komprehensif untuk mendapatkan data form dengan penduduk terkait
...
-- Buat fungsi untuk mengupdate data form_tugas_data dengan penduduk terkait
...
BEGIN
    ...
    FROM (
        SELECT * FROM form_tugas_data WHERE id = p_form_data_id
    ) row;
